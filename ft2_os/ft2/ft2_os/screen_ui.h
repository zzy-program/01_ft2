...
class ScreenRecoveryUI : public RecoveryUI {
  public:
    ...
    //DumpFramebuffer
    virtual char* DumpFramebuffer(Icon icon, int *width, int *height, int *bpp);
  ...
  protected:
    ...
    GRSurface* progressBarEmpty = nullptr;
    GRSurface* progressBarFill = nullptr;
    GRSurface* stageMarkerEmpty = nullptr;
    GRSurface* stageMarkerFill = nullptr;
#ifdef HTC_HEP_PROJECT_FLAG
    GRSurface* backgroundIcon[ICON_NUM];
    GRSurface* progressBarIndeterminate[PROGRESSBAR_STATES];
